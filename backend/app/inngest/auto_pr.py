...
async def handle_auto_pr(ctx: inngest.Context):
    ...
    branch_name = f"coderabbit/issue-{issue_number}"
    ...
    for change in changes:
        if change["action"] == "delete":
            ...
            await github.create_or_update_file(
                ...
                change["path"],
                change["content"],
                f"{f'Create' if change['action'] == 'create' else 'update'} {change[f'path']} for #{issue_number}",
                branch_name,
                change.get("sha"),
                token,
            )
...
---
*This PR was automatically generated by CodeRabbit from issue #{issue_number}*
"""
